...
using Gemini.Demo.FilterDesigner.Modules.FilterDesigner.Design;
using Gemini.Demo.FilterDesigner.Modules.FilterDesigner.Util;
using Gemini.Demo.FilterDesigner.Modules.FilterDesigner.ViewModels.Elements;
using Gemini.Framework;
using Gemini.Modules.Inspector;
using ImageSource = Gemini.Demo.FilterDesigner.Modules.FilterDesigner.ViewModels.Elements.ImageSource;
